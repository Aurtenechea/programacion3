<?php
    class DBAccess{
        ...
        private function __construct(){
            try {
                $this->PDO = new PDO('mysql:host=localhost;dbname=ej_abm_parcial;charset=utf8', 'root', 'qweasdzxc', array(PDO::ATTR_EMULATE_PREPARES => false,PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
        ...
        /*  Cuando uno necesita conectarse a la DB pide un objeto DBAccess.
            ...
            mismo. Esto creara un objeto PDO para para manejar intenamente
            las consultas. */
